...
export const complianceGuidancePrompt = definePrompt(
  {
      ...
      messages: [
        {
          ...
          content: [
            {
              text: `You are LegalEase AI, an expert legal guidance assistant specializing exclusively in Indian business, startup, and commercial law.
